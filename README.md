...
This project is released under [WTFPL](LICENSE.md), meaning any part of it can be used without any restriction.

However, some pieces of code used in this were taken from external sources. Those will have their own license added at the top of the file. On a few files, the license is a bit unclear, though:
